import 'package:code_capsule_background/editPage/util/page_util.dart';
...
class _FunctionTitleState extends State<FunctionTitle> {
  ...
  void initState() {
    ...
    widget.pageUtil
        .setRefreshTitleAfterPageViewLoad(refreshTitleAfterPageViewLoad);
  }
  ...
  void refreshTitleAfterPageViewLoad() {
    ...
    instance.addPostFrameCallback((timeStamp) {
      ...
      initY = renderBox.localToGlobal(Offset.zero).dy - containerY - 12;
      firstX = renderBox.localToGlobal(Offset.zero).dx - containerX - 22;
      renderBox = keySecond.currentContext!.findRenderObject()! as RenderBox;
      secondX = renderBox.localToGlobal(Offset.zero).dx - containerX - 22;
      renderBox = keyThired.currentContext!.findRenderObject()! as RenderBox;
      thiredX = renderBox.localToGlobal(Offset.zero).dx - containerX - 22;
      refreshUi();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: 55,
      padding: const EdgeInsets.only(left: 22, right: 24, top: 12, bottom: 6),
              ...
              SizedBox(
                child: InkWell(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(KString.editEditTitle, style: KFont.funcTitleStyle),
                      const SizedBox(
                        height: 6,
                      ),
                      Container(
              ...
              SizedBox(
                child: InkWell(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        KString.editCategoryTitle,
                        style: KFont.funcTitleStyle,
                      ),
                      const SizedBox(
                        height: 6,
                      ),
